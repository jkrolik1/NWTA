...
--
-- Host: 127.0.0.1
-- Czas generowania: 24 Mar 2021, 21:33
...
CREATE TABLE `produkt` (
  ...
  `Opis` varchar(10000) COLLATE utf8_polish_ci DEFAULT NULL,
...
(0, 'https://upload.wikimedia.org/wikipedia/commons/d/da/Guppy_02.jpg', 'Ta pochodząca z Karaibów słodkowodna rybka jest bez wątpienia najbardziej popularną rybką akwariową. Pawie oczko, bardziej znane pod nazwą gupik, uchodzi za rybę nieskomplikowaną w pielęgnacji i nadającą się optymalnie dla poczatkujących akwarystów.', 25, 0, 'Pawie oczko'),
(1, 'https://www.zooplus.pl/magazyn/wp-content/uploads/2019/08/Neonsalmler-1024x768.jpeg', 'Za sprawą czerwonych i niebieskich neonowych pasów na ciele bystrzyka stanowi on prawdziwą wizualną atrakcję w akwarium. Te niewielkie, pochodzące z obszaru Amazonki rybki słodkowodne, pływając wyłącznie w ławicy będą czuły się w akwarium komfortowo — powinny być trzymane z przynajmniej 10 przedstawicielami swojego gatunku — im więcej, tym lepiej.', 35, 0, 'Bystrzyk neonowy'),
(3, 'https://www.zooplus.pl/magazyn/wp-content/uploads/2019/08/black-molly.jpeg', 'Molinezja ostropyska to czarna rybka z wód Południowej i Środkowej Ameryki. Poprzez krzyżowanie z innymi odmianami hodowlanymi powstawały różne formy łusek i tak powstała Black Molly z małą, okrągłą płetwą grzbietową, o wielkości od 6 do 10 cm. Te czarne jak węgielki ryby ozdobne uchodzą za wytrzymałe i łatwe w pielęgnacji, jednak kochające ciepło silnie reagują na zmiany temperatury oraz stopnia twardości wody.', 32, 0, 'Black Molly'),
(4, 'https://www.zooplus.pl/magazyn/wp-content/uploads/2019/08/panzerwels-1024x683.jpeg', 'Kolejny popularny mieszkaniec naszych akwariów, należący do rodzaju Corydoras. Kiryski uwielbiają towarzystwo swoich krewnych, w ich przypadku zaleca się trzymanie w jednym akwarium kilku par z tego gatunku. Kirysek posiada gładkie, ponakładane na siebie wzajemnie płytki kostne, które ochraniają jego ciało od głowy po płetwę ogonową.', 28, 0, 'Kirysek pstry'),
(7, 'https://www.zooplus.pl/magazyn/wp-content/uploads/2019/08/skalar-1024x683.jpeg', 'Skalary, zwane także żaglowcami, rzucają się w oczy ze względu na przypominający właśnie żagle kształt ciała, który zawdzięczają długim płetwom grzbietowej i odbytowej. Skalary zachwycają nie tylko niezwykłym kształtem ciała, lecz również imponują rozmiarami — osiągają długość do 15 cm i wysokość do 25 cm z płetwami.', 32, 0, 'Skalar'),
(9, 'https://www.zooplus.pl/magazyn/wp-content/uploads/2019/08/zebrab%C3%A4rbling-1024x683.jpeg', 'Te żywotne, kochające pływać rybki cieszą się niezwykłą popularnością wśród akwarystów na całym świecie. Także osoby początkujące w dziedzinie akwarystyki z pewnością dadzą sobie radę w utrzymaniu tej niewymagającej rybki, która doskonale czuje się w towarzystwie wielu innych gatunków słodkowodnych rybek.', 45, 0, 'Danio pręgowany'),
(10, 'https://upload.wikimedia.org/wikipedia/commons/5/5b/Chomik_syryjski_%28Just_a_Dream%29.jpg', 'To pełen energii, inteligentny gryzoń, większy od innych hodowanych w domach gatunków chomików. Choć nie wchodzi w tak głęboką interakcję z człowiekiem, jak kot czy pies, może dostarczyć wiele radości osobom, które pragną mieć mało absorbującego, niekłopotliwego w obsłudze pupila.', 190, 0, 'Chomiczek syryjski'),
(11, 'https://polki.pl/foto/4_3_LARGE/chomik-roborowskiego-cena-zywienie-oswajanie-chomika-2417306.jpg', 'Chomiki karłowate są ze swoją wagą od 25 do maksymalnie 50 g i długością ciała od 7 do 10 cm znacznie mniejsze od swoich krewnych, chomików syryjskich. Najdłuższy z nich, chomik chiński osiąga długość do 12 cm, jednak w tym wymiarze zawiera się jeszcze ogon o długości 2-3 cm. Najmniejszym z chomików karłowatych jest chomik Roborowskiego, jego długość wynosi często nawet jedynie 5 cm.', 231, 0, 'Chomik karłowaty'),
(20, 'https://www.akwarystyczny24.pl/zdjecia/produkt/5460/12502/0x992/3m/Pleco_Veggie_Wafers_100ml.jpg', 'Bogata w minerały cukinia zapewnia rybom dobre samopoczucie i witalność.\r\nPokarm zawiera błonnik ułatwiający trawienie.\r\nNie brudzi wody.', 30, 1, 'Tetra Pleco Veggie 250ml'),
(21, 'https://a.allegroimg.com/s512/11c5d4/1c47ccbb4da5ac9b89c35651f97d/ROYAL-CANIN-Maxi-Adult-2x15kg', 'Optymalne trawienie.\r\nOchrona kości i stawów.\r\nZawiera kwasy tłuszczowe omega-3: EPA i DHA.', 380, 1, 'Royal Canin Maxi Adult 2 x 15 kg'),
(22, 'https://media.os.fressnapf.com/products/img/1099277/1099277_8840329123541.jpg', 'Z łososiem i marchewką.\r\nKarma wysokiej jakości\r\nniepowtarzalny smak.\r\nOpracowana przez lekarzy weterynarii i specjalistów w zakresie żywienia.', 56, 1, 'Purina ONE Sterilcat 24 × 85 g '),
...
(46, 'https://archiwum.allegro.pl/image//imagesNEW/big/391a0c788569fb4d65b9b1732d8ee51ecc785df27e14f1a54a4ecc5ac52de30a', 'Zabawka w postaci marchewki Trixie to doskonały wybór dla królików i gryzoni. Jest wykonana wyłącznie z naturalnych materiałów. Rolka została owinięta bawełnianą przędzą. Zabawka zapewni zwierzęciu wiele godzin zabaw.', 14, 2, 'Trixie Zabawka gryzak'),
